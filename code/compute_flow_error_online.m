function [total_cost] = compute_flow_error_online(image_sequence,frame_number,ref_frame,options)
...
direction = sign(ref_frame-frame_number);
frame_index = cell(1,1);
frame_index{1} = frame_number+direction:direction:ref_frame;
total_cost = zeros(r,c);
